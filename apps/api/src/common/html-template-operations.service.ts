...
export function htmlTemplateSampleContext(): Record<string, unknown> {
  return {
    event: {
      ...
      tagline: '让每一次相聚都顺利发生',
      description: '两天密集分享与实战工作坊，覆盖大会发布、报名交易和现场履约。',
      ...
      stats: { seats: 680, speakers: 42, days: 2, attendeeSatisfaction: 96.8 },
    },
    tickets: [
      {
        name: '早鸟通票',
        description: '两日大会与资料包',
        price: 39900,
        currency: 'CNY',
        remaining: 117,
        benefits: ['两日参会', '大会资料包'],
    ...
    speakers: [
      { name: 'Alex Chen', role: '大会运营负责人', topic: '把大会流程变成可复用的系统能力' },
      { name: 'Maya Lee', role: '活动产品负责人', topic: '从参会旅程到现场体验' },
    ],
    sessions: [
      {
        day: 1,
        startsAt: '2026-08-18T01:30:00.000Z',
        endsAt: '2026-08-18T02:10:00.000Z',
        title: '大会运营趋势与实践地图',
        summary: '结合真实流程拆解内容发布、报名交易和现场协作。',
        speaker: 'Alex Chen',
      },
    ],
    faqs: [
      {
        question: '大会适合哪些人参加？',
        answer: '适合大会主办方、运营团队、活动技术服务商和开发者。',
      },
    ],
    routes: { registration: '/register', faq: '/faq', account: '/account' },
    site: {
      footerText: 'TokEMS Demo Conference',
